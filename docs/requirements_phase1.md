...
* **US-5:** 私は、腐敗していく在庫や変動する価格を見て、今何を運ぶべきかの戦略的判断を行いたい。
...
* **US-9:** システムは、商品の**腐敗（Decay）**とステーションでの**生産・消費**を行い、常に需要が発生し続ける状態を維持したい。
...
* **腐敗と生産サイクル:**
    * 全ての物資には「鮮度」や「耐久」があり、時間経過で価値が落ちる（腐敗）。
